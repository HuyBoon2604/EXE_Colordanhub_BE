...
namespace Booking_Dance_Data.Migrations
{
    ...
    [Migration("20250204121605_fix_init_Capacity_Table")]
    partial class fix_init_Capacity_Table
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Booking_Dance_Data.Models.Entities.ClassDance", b =>
                {
                    ...
                    b.HasOne("Booking_Dance_Data.Models.Entities.Account", null)
                        .WithMany("ClassDances")
            ...
            modelBuilder.Entity("Booking_Dance_Data.Models.Entities.Studio", b =>
                {
                    ...
                    b.HasOne("Booking_Dance_Data.Models.Entities.Category", null)
                        .WithMany("Studios")
